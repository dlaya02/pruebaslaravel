        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="frontend/index.html">Flat<span>Lab</span></a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="frontend/index.html">Home</a></li>
                        <li><a href="frontend/about.html">About</a></li>
                        <li><a href="frontend/services.html">Service</a></li>
                        <li class="dropdown ">
                            <a href="frontend/#" class="dropdown-toggle " data-toggle="dropdown" data-hover="dropdown" data-delay="0" data-close-others="false">Feature <b class=" fa fa-angle-down"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="frontend/typography.html">Typography</a></li>
                                <li><a href="frontend/button.html">Buttons</a></li>
                            </ul>
                        </li>
                        <li><a href="frontend/portfolio.html">Portfolio</a></li>
                        <li><a href="frontend/price.html">Price</a></li>
                        <li><a href="frontend/blog.html">Blog</a></li>
                        <li><a href="frontend/contact.html">Contact</a></li>
                        <li class="dropdown language">
                            <a href="frontend/#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                <img alt="" src="frontend/img/flags/us.png">
                                <span class="username">US</span>
                                <b class=" fa fa-angle-down"></b>
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="frontend/#"><img alt="" src="frontend/img/flags/es.png"> Spanish</a></li>
                                <li><a href="frontend/#"><img alt="" src="frontend/img/flags/de.png"> German</a></li>
                                <li><a href="frontend/#"><img alt="" src="frontend/img/flags/ru.png"> Russian</a></li>
                                <li><a href="frontend/#"><img alt="" src="frontend/img/flags/fr.png"> French</a></li>
                            </ul>
                        </li>
         ...
         <div class="fullwidthabnner">
             <ul id="revolutionul" style="display:none;">
                 ...
                 <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="">
                     ...
                     <a class="caption lfr btn yellow slide_btn" href="frontend/http://thevectorlab.net/flatlab" target="_blank"
                        data-x="670"
                        data-y="400"
                        data-speed="400"
                        data-start="3500"
                 ...
                 <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="">
                     ...
                     <img src="frontend/img/banner/banner_bg.jpg" alt="">
                     ...
                     <a class="caption lft slide_btn btn red slide_item_left" href="frontend/#" target="_blank"
                        data-x="10"
                        data-y="360"
                        data-speed="400"
                        data-start="3000"
        ...
        <div class="row">
            ...
            <div class="quote">
                ...
                <div class="col-lg-3 col-sm-3">
                    <a href="frontend/http://themeforest.net/item/flatlab-bootstrap-3-responsive-admin-template/5902687?WT.ac=portfolio&WT.z_author=vectorlab" class="btn btn-danger purchase-btn" target="_blank">Purchase now</a>
                </div>
            </div>
            <!--quote end-->
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-sm-6">
                    ...
                    <a href="frontend/http://themeforest.net/item/flatlab-bootstrap-3-responsive-admin-template/5902687?WT.ac=portfolio&WT.z_author=vectorlab" target="_blank" class="btn btn-purchase">Purchase now</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <section class="panel tab">
                    <header class="panel-heading tab-bg-dark-navy-blue">
                        <ul class="nav nav-tabs nav-justified ">
                            <li class="active">
                                <a data-toggle="tab" href="frontend/#news">
                                    News
                                </a>
                            </li>
                            <li>
                                <a data-toggle="tab" href="frontend/#events">
                                    Events
                                </a>
                            </li>
                            <li class="">
                                <a data-toggle="tab" href="frontend/#notice-board">
                                    Notice board
                                </a>
                            </li>
                        </ul>
                        ...
                        <div class="tab-content tasi-tab">
                            <div id="news" class="tab-pane active">
                                <article class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="frontend/#" class=" p-head">News Tittle goes here</a>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                    </div>
                                </article>
                                <article class="media">
                                    <a class="pull-left thumb p-thumb">
                                        <img src="frontend/img/product2.png" alt="">
                                    </a>
                                    <div class="media-body">
                                        <a href="frontend/#" class=" p-head">News Tittle goes here 2</a>
                                ...
                                <article class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="frontend/#" class=" p-head">News Tittle goes here 3</a>
                            ...
                            <div id="events" class="tab-pane">
                                <article class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="frontend/#" class="cmt-head">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
                                ...
                                <article class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="frontend/#" class="cmt-head">Nulla vel metus scelerisque ante sollicitudin commodo</a>
                                ...
                                <article class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="frontend/#" class="cmt-head">Donec lacinia congue felis in faucibus. </a>
                        ...
                        <div class="flexslider">
                            <ul class="slides about-flex-slides">
                                <li>
                                    ...
                                    <a class="about-testimonial-author" href="frontend/#">Ericson Reagan</a>
                                ...
                                <li>
                                    ...
                                    <a class="about-testimonial-author" href="frontend/#">Jonathan Smith</a>
                ...
                <ul class="bxslider">
                    <li>
                        <div class="element item view view-tenth" data-zlname="reverse-effect">
                            ...
                            <div class="mask">
                                <a data-zl-popup="link" href="frontend/javascript:;">
                 ...
                 <div class="row">
                     <div class="col-lg-12 text-center">
                         <ul class="list-unstyled">
                             <li><a href="frontend/#"><img src="frontend/img/clients/logo1.png" alt=""></a></li>
                             <li><a href="frontend/#"><img src="frontend/img/clients/logo2.png" alt=""></a></li>
                             <li><a href="frontend/#"><img src="frontend/img/clients/logo3.png" alt=""></a></li>
                             <li><a href="frontend/#"><img src="frontend/img/clients/logo4.png" alt=""></a></li>
                             <li><a href="frontend/#"><img src="frontend/img/clients/logo5.png" alt=""></a></li>
                         </ul>
                     </div>
                 </div>
             </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-3">
                    ...
                    <address>
                        ...
                        <p>Email : <a href="frontend/javascript:;">support@vectorlab.com</a></p>
                    </address>
                </div>
                <div class="col-lg-5 col-sm-5">
                    ...
                    <div class="tweet-box">
                        ...
                        <em>Please follow <a href="frontend/javascript:;">@nettus</a> for all future updates of us! <a href="frontend/javascript:;">twitter.com/vectorlab</a></em>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-3 col-lg-offset-1">
                    ...
                    <ul class="social-link-footer list-unstyled">
                        ...
                        <li><a href="frontend/#"><i class="fa fa-dribbble"></i></a></li>
                        <li><a href="frontend/#"><i class="fa fa-linkedin"></i></a></li>
                        <li><a href="frontend/#"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="frontend/#"><i class="fa fa-skype"></i></a></li>
                        <li><a href="frontend/#"><i class="fa fa-github"></i></a></li>
