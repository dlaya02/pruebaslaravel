...
<!--recent work start-->
    <div class="container pulishing-container">  
        <div class="row ">
            
            <div class="col-sm-3 pulishing-phone" style="">
              <div class="element item view view-tenth" data-zlname="reverse-effect">
                <img src="http://pruebaslaravel/img/default/0.jpg" class="thumbnail-img" style="" />
                  <div class="mask">
  ...
  <div class="row">
      <div class="col-lg-12" style="background-color: lightblue;">
        <ul class="bxslider" style="background-color: red;">
        <div class="publicity-img-cotent" style="background-color: blue;" >
        <li>
            <div class="element item view view-tenth img-brand" data-zlname="reverse-effect">
                <img src="http://pruebaslaravel/img/default/0.jpg" alt=""  />
                  <div class="mask">
                    <a data-zl-popup="link2" class="fancybox" rel="group" href="img/works/img1.jpg">
                      <i class="fa fa-search"></i>
                    </a>
         ...
         <div class="publicity-img-cotent" >
            <div class="element item view view-tenth img-brand" data-zlname="reverse-effect">
                <img src="http://pruebaslaravel/img/default/0.jpg" alt=""  />
                  <div class="mask">
                    <a data-zl-popup="link2" class="fancybox" rel="group" href="img/works/img1.jpg">
