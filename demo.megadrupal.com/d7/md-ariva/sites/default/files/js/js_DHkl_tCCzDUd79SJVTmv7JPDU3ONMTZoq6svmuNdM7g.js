...
(function($) {
    ...
    if(windowWidth>=320) {
       $('.animated_background').css({'height': $(window).height()-83+'px'});
       $('.header-menu-hidden .animated_background').css({'height': $(window).height()+'px'});
    }

		//Background parallax
   var pageSection = $(".bg-parallax");
    ...
    //ANIMATE
	        ...
	        var banner = $(".animated_background");
