...
(function ($) {
    $(document).ready(function(){
        ...
        if(windowWidth>=320) {
            $('.slider-paralax').css({'width': windowWidth +'px'});
            $('.parallax_slider,.slider-paralax').css({'height': $(window).height()-83+'px'});
            $('.header-menu-hidden .parallax_slider,.header-menu-hidden .bg-parallax').css({'height': $(window).height()+'px'});
        }

        $('li.slider-paralax').each(function(){
        ...
        //Slider
        var slideCount = $('.parallax_slider ul.slides-container-parallax li').length;
        var slideWidth = $('.parallax_slider ul.slides-container-parallax.slides-container-parallax li').width();
        var slideHeight = $('.parallax_slider ul.slides-container-parallax li').height();
        var sliderUlWidth = slideCount * slideWidth;

        $('.parallax_slider').css({ width: slideWidth, height: slideHeight });

        $('.parallax_slider ul.slides-container-parallax').css({ width: sliderUlWidth, marginLeft: - slideWidth });

        $('.parallax_slider ul.slides-container-parallax li:last-child').prependTo('.parallax_slider ul.slides-container-parallax');

        function moveLeft() {
            $('.parallax_slider ul.slides-container-parallax').animate({
                left: + slideWidth
            }, 200, "swing", function() {
                $('.parallax_slider ul.slides-container-parallax li:last-child').prependTo('.parallax_slider ul.slides-container-parallax');
                $('.parallax_slider ul').css('left', '');
            });
        };
        ...
        function moveRight() {
            $('.parallax_slider ul.slides-container-parallax').animate({
                ...
                $('.parallax_slider ul.slides-container-parallax li:first-child').appendTo('.parallax_slider ul.slides-container-parallax');
                $('.parallax_slider ul').css('left', '');
            });
        };
...
(function ($, undefined) {
    ...
    //SLIDE SIGNLE PRODUCT
    $(window).on('load', function(){
        $('#ts-lightSlider').lightSlider({
            gallery: true,
            item: 1,
            loop: true,
            slideMargin: 0,
    ...
    SingleSelect2 = clazz(AbstractSelect2, {
        ...
        createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span class='select2-arrow' role='presentation'><i class='icon fontello icon-down-open'></i></span>",
                "</a>",
...
(function($, window, document, undefined) {
  $(window).on('load', function(){
    ...
    /*********************************
     init cubeportfolio
     *********************************/
		$(".cbp-item ",gridContainer).height($(".cbp-item ",gridContainer).width()*350/474); 
...
(function($){
    $(document).ready(function(){
        ...
        //
        $('.ts-item-member').on( "click", function() {
        ...
        $('.menu-open').on( "click", function() {
            $('.ts-main-menu').animate({
                ...
                height:"100%"
            },1000).css({"visibility":"visible","z-index":"888"})
            $('.social-top').hide();
        });
        $('.close-menu').on( "click", function() {
            $('.ts-main-menu').animate({
                ...
                $(this).css({"visibility":"hidden","z-index":"0"})
            })
            $('.social-top').show();
        });
        ...
        //MENU ONEPAGE
        $(".ts-default-menu ul.default-nav a").on( "click", function(e) {
            var windowWidth = $(window).width();
            if(windowWidth<=959) {
                $('.ts-default-menu ul.default-nav').slideUp("fast");
            }
            var url = $(this).attr("href").replace(/^([^]+\/)/i, '');
        ...
        /*Main Menu Scroll*/
        var offs = '15%';
        if ($(".awecontent-section").length > 0) {
            $(".awecontent-section").waypoint({
                handler: function(event, direction) {
                    var active_section = $(this);
                    if (direction === "up") active_section = active_section.prev();
                    if (direction === "up") offs = '30%';
                    if(typeof active_section.attr("id") != 'undefined') {
                        $(".main-header a").removeClass("active active-trail");
                        $('.main-header a[href="' +Drupal.settings.basePath+ '#' + active_section.attr("id") + '"]').addClass("active");
                    }
                },
                offset: offs
            });
...
(function($) {
    ...
    $(document).ready(function(){
        ...
        var $wrapperMdfFullscreen = $('.block-md-fullscreen-slider .content'),
                $menuHeader = $('.header-basic .main-header');
    ...
    Drupal.behaviors.custom_content = {
        attach:function (context, settings) {
            ...
            //Fix Heigh fullscreen
            // menu
            if ($('ul li.expanded > a i.icon').length < 1) {
                $('ul li.expanded > a').append('<i class="icon icon-down-dir"></i>');
            }
        }
    };
